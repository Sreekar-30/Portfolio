...
export default function Skills() {
  return (
    <section className="relative z-20 bg-transparent min-h-screen py-32 px-4 md:px-12 overflow-hidden" id="skills">
      {/* Background Ambience */}
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl leading-relaxed">
            A comprehensive set of languages, backend frameworks, database systems, and software engineering practices.
          </p>
        </motion.div>
